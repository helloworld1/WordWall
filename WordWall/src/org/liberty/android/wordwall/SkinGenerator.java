...
public class SkinGenerator {
    ...
    public Skin getSkin() {
        ...
        BitmapFont defaultBigFont = new BitmapFont(Gdx.files.internal("fonts/dsf.fnt"), fontImageTextureRegion);
        defaultBigFont.setScale(2.0f);

        BitmapFont defaultMediumFont = new BitmapFont(Gdx.files.internal("fonts/dsf.fnt"), fontImageTextureRegion);
        defaultMediumFont.setScale(1.5f);

        BitmapFont defaultSmallFont = new BitmapFont(Gdx.files.internal("fonts/dsf.fnt"), fontImageTextureRegion);
        defaultSmallFont.setScale(1.0f);
